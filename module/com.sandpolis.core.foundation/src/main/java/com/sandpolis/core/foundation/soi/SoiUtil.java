...
/**
 * This class contains SOI utilities.
 *
 * @author cilki
 * @since 5.0.0
 */
public final class SoiUtil {
	...
	public static DependencyArtifact getMatrix(Path file) throws IOException {
		SO_DependencyMatrix matrix = readMatrix(file);
		return new DependencyArtifact(matrix, matrix.getArtifact(0));
	}
