...
import com.sandpolis.core.instance.state.container.AttributeContainer;
import com.sandpolis.core.instance.state.container.CollectionContainer;
...
public interface STDocument
		extends STObject<ProtoDocument>, AttributeContainer, DocumentContainer, CollectionContainer {
