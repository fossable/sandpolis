 ...
 *                                                                            *
 *****************************************************************************/
package com.sandpolis.viewer.net.init;
 ...
 * as a viewer connection.
 * 
 * @author cilki
 * @since 5.0.0
 */
public class ViewerInitializer extends PipelineInitializer {

	/**
	 * All viewer {@link Exelet} classes.
	 */
	@SuppressWarnings("unchecked")
	private static final Class<? extends Exelet>[] exelets = new Class[] {};

	public ViewerInitializer() {
		super(exelets, Instance.VIEWER);
	}

	@Override
	protected void initChannel(Channel ch) throws Exception {
		super.initChannel(ch);
		CVID.initiateHandshake(ch, Instance.VIEWER);
	}
