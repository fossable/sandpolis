...
in mkShell {
  ...
  shellHook = ''
    ...
    echo "To build APK:"
    echo "  # Debug build:"
    echo "  cargo ndk -t arm64-v8a -p 31 -o android/app/src/main/jniLibs build --link-libcxx-shared"
    echo "  cd android && ./gradlew assembleDebug"
    echo ""
    echo "  # Release build:"
    echo "  cargo ndk -t arm64-v8a -p 31 -o android/app/src/main/jniLibs build --release --link-libcxx-shared"
