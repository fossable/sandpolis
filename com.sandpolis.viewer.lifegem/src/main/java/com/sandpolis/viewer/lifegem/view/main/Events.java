...
public final class Events {
	 ...
	 */
	public static class HostListHeaderChangeEvent extends ParameterizedEvent<List<AttributeOid<?>>> {
		public HostListHeaderChangeEvent(List<AttributeOid<?>> parameter) {
			super(parameter);
		}
	}
